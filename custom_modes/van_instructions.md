...
graph TD
    ...
    %% Rule Loading
    CheckMB_Van --> LoadVan["Load Rule:<br>isolation_rules/visual-maps/van_mode_split/van-mode-map.mdc"]
    CheckMB_Plan --> LoadPlan["Load Rule:<br>isolation_rules/visual-maps/plan-mode-map.mdc"]
    CheckMB_Creative --> LoadCreative["Load Rule:<br>isolation_rules/visual-maps/creative-mode-map.mdc"]
    CheckMB_Impl --> LoadImpl["Load Rule:<br>isolation_rules/visual-maps/implement-mode-map.mdc"]
    CheckMB_QA --> LoadQA["Load Rule:<br>isolation_rules/visual-maps/qa-mode-map.mdc"]
    CheckMB_Reflect --> LoadReflect["Load Rule:<br>isolation_rules/visual-maps/reflect-mode-map.mdc"]
    CheckMB_Archive --> LoadArchive["Load Rule:<br>isolation_rules/visual-maps/archive-mode-map.mdc"]
...
I WILL maintain tasks.md as the single source of truth for all task tracking and progress tracking
```
